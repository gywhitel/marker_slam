...
public:
    ...
    friend tf2::Stamped<TransformWithVariance> operator*(tf2::Stamped<TransformWithVariance> lhs, const tf2::Transform& rhs) {
      lhs.transform = lhs.transform * rhs;
      return lhs;
    }

    friend tf2::Stamped<TransformWithVariance> operator*(const tf2::Transform& lhs, tf2::Stamped<TransformWithVariance> rhs) {
...
inline geometry_msgs::msg::PoseWithCovarianceStamped toPose(const tf2::Stamped<TransformWithVariance>& in) {
